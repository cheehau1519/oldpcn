...
//       
//       var EscapeDesc = returnData.rows.item(y).desc;
//       var ConvertDesc = escapeHtml(EscapeDesc);
//       var desc_value = '"'+ConvertDesc+'"';
//       
//       var EscapeDesc2 = returnData.rows.item(y).desc2;
//       var ConvertDesc2 = escapeHtml(EscapeDesc2);
//       var desc2_value = '"'+ConvertDesc2+'"';
